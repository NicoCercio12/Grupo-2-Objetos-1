...
public class TestSistema {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("\n 7) Agregar Detalles de Venta a Pedidos");
		...
		System.out.println("\n 13) Intentar agregar festival duplicado");
		try {
			sis.agregarFestival("Epicentro Verano", "Verano", "Gastronomia", LocalDate.of(2024, 1, 1),
					LocalDate.of(2024, 1, 31));
		} catch (Exception e) {
		...
		System.out.println("\n 15) Intentar agregar pedido fuera de fecha del festival");
		try {
